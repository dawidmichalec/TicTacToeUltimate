...
class ThreeRoundsFiveDim(Screen):
    ...
    def three_cross_wins_round_two(self):
        ...
        self.round += 1
        self.reset_playground()
        App.get_running_app().root.current = 'three_five_dim_cross_wins_round_two'
        return True
    ...
    def three_cross_wins_round_three(self):
        if self.cross_win == 0:
            ...
            self.round += 1
            self.reset_playground()
            App.get_running_app().root.current = 'three_five_dim_cross_wins_round_three'
            return True
    ...
    def three_cross_wins_round_four(self):
        if self.cross_win == 0:
            ...
            self.round += 1
            self.reset_playground()
            App.get_running_app().root.current = 'three_five_dim_cross_wins_round_four'
            return True
    ...
    def three_cross_wins_final_round(self):
        if self.cross_win == 1:
            ...
            self.round += 1
            self.reset_playground()
            App.get_running_app().root.current = 'three_five_dim_cross_wins_final_round'
            return True
    ...
    def cross_wins(self):
        ...
        self.round += 1
        self.str_cross_win = str(self.cross_win)
        App.get_running_app().root.current = 'three_five_dim_cross_wins_the_match'
    ...
    def three_circle_wins_round_two(self):
        ...
        self.round += 1
        self.reset_playground()
        App.get_running_app().root.current = 'three_five_dim_circle_wins_round_two'
        return True
    ...
    def three_circle_wins_round_three(self):
        if self.circle_win == 0:
            ...
            self.round += 1
            self.reset_playground()
            App.get_running_app().root.current = 'three_five_dim_circle_wins_round_three'
            return True
    ...
    def three_circle_wins_round_four(self):
        if self.circle_win == 0:
            ...
            self.round += 1
            self.reset_playground()
            App.get_running_app().root.current = 'three_five_dim_circle_wins_round_four'
            return True
    ...
    def three_circle_wins_final_round(self):
        if self.circle_win == 1:
            ...
            self.round += 1
            self.reset_playground()
            App.get_running_app().root.current = 'three_five_dim_circle_wins_final_round'
            return True
    ...
    def circle_wins(self):
        ...
        self.round += 1
        self.str_circle_win = str(self.circle_win)
        App.get_running_app().root.current = 'three_five_dim_circle_wins_the_match'
        ...
        if turn_count == 10 and check_win_cross is not True and check_win_circle is not True:
            match round:
                case 1:
                    ...
                    self.circle_win += 1
                    self.cross_win += 1
                    App.get_running_app().root.current = 'three_five_dim_draw_round_three'
                    return True
                case 2:
                    if self.three_circle_wins_round_two() is not True:
                        if self.circle_win == 1:
                            ...
                            self.circle_win += 1
                            self.cross_win += 1
                            App.get_running_app().root.current = 'three_five_dim_draw_round_four'
                            return True
                ...
                case 3:
                    if self.three_circle_wins_round_three() is not True:
                        if self.circle_win == 1 and self.cross_win == 1:
                            ...
                            self.circle_win += 1
                            self.cross_win += 1
                            App.get_running_app().root.current = 'three_five_dim_draw_final_round'
                            return True
                ...
                case 5:
                    if self.three_circle_wins_final_round() is not True:
                        ...
                        App.get_running_app().root.current = 'three_rounds_five_dim_draw'
                        return True
    ...
    def dropdown(self):
        menu_list = [
            ...
            },
            {
                ...
                "on_release": lambda x="RETURN TO MAIN MENU": [Factory.get('ThreeRoundsFiveDimPopup')().open(), menu.dismiss()],
                "theme_text_color": "Custom",
                "text_color": [1, 1, 1, 1],
                "text_style": "BUTTON",
                "font_style": "H6"
