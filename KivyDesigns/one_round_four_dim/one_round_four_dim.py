...
class OneRoundFourDim(Screen):
    ...
    def check_win_cross(self):
        ...
        if self.ids.fourteen.background_disabled_normal == self.cross_path and self.ids.fifteen.background_disabled_normal\
            ...
            App.get_running_app().root.current = 'one_round_four_dim_cross_wins'
            return True
    ...
    def check_win_circle(self):
        ...
        if self.ids.fourteen.background_disabled_normal == self.circle_path and self.ids.fifteen.background_disabled_normal\
            ...
            App.get_running_app().root.current = 'one_round_four_dim_circle_wins'
            return True
